...
$createItem.mapper.columnValues | Add-Member -NotePropertyName date_mm50qbrx -NotePropertyValue ([ordered]@{
    datetime = '{{formatDate(42.data.days[1].spots[1].start_time; "YYYY-MM-DDTHH:mm:ss"; "Asia/Jerusalem")}}'
...
$createdItem = New-MondayGetItemModule -Id 43 -ItemId '{{30.id}}' -X 1800 -Name 'Monday - קריאת כתובת המייל מהפריט שנוצר'
...
$emailHtmlVariable.metadata.designer.x = 2100
...
$sendEmail.metadata.designer.x = 2400
