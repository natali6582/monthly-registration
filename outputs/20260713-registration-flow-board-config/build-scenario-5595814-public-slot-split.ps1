        ...
        mapper = [ordered]@{
            ...
            columnValuesToChange = @(
                [ordered]@{
                    ...
                    columnValue = [ordered]@{
                        date = '{{formatDate(get(split(get(split(toString(42.data); "\"start_time\":\""); 2); "\""); 1); "YYYY-MM-DDTHH:mm:ss"; "Asia/Jerusalem")}}'
                        includeTime = $true
                    }
                },
                [ordered]@{
...
$eventRange.mapper.parseResponse = $false
...
$startTime = 'get(split(get(split(toString(42.data); "\"start_time\":\""); 2); "\""); 1)'
